  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0">
        {Array.from({
          length:
            window.innerWidth < 768 ? 10 : window.innerWidth < 1024 ? 15 : 20,
        }).map((_, i) => (
          <div
            key={i}
      ...
      <div className="relative flex flex-col items-center justify-center h-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24 max-w-7xl mx-auto text-center">
        ...
        <div className="text-white z-10 w-full">
          <h1
            className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-normal  sm:mb-6 md:mb-8 bg-clip-text text-gray-200 leading-tight tracking-wide"
          ...
          <p
            className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl sm:mb-8 md:mb-10 text-gray-200 max-w-xs xs:max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto font-normal leading-relaxed px-2 sm:px-0"
            style={{ fontFamily: 'Raleway, sans-serif' }}
          >
            Join forces with industry leaders to drive innovation, accelerate
            growth, and create exceptional value for customers worldwide.
          </p>
          ...
          <div className="flex flex-col xs:flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center items-center w-full max-w-md sm:max-w-2xl mx-auto">
            <button
              onClick={() => {
                document
                  .getElementById('why-partner')
                  ?.scrollIntoView({ behavior: 'smooth' });
              }}
              className="group relative w-full xs:w-full sm:w-auto px-6 xs:px-8 sm:px-10 md:px-12 py-3 xs:py-4 sm:py-5 bg-gradient-to-r from-purple-600 to-blue-800 rounded-lg sm:rounded-xl overflow-hidden transition-all duration-300 hover:bg-blue-700 hover:scale-105 hover:shadow-[0px_0px_20px_0px_rgba(59,130,246,0.7)] sm:hover:shadow-[0px_0px_35px_0px_rgba(59,130,246,0.7)]"
              style={{
            ...
            >
              <span className="text-white text-sm xs:text-base sm:text-lg md:text-xl font-normal leading-tight relative z-10">
                View Specifications
              </span>
            </button>
            ...
            <button
              ...
              className="group relative w-full xs:w-full sm:w-auto px-6 xs:px-8 sm:px-10 md:px-12 py-3 xs:py-4 sm:py-5 bg-transparent border border-purple-600 rounded-lg sm:rounded-xl overflow-hidden transition-all duration-300 hover:bg-purple-600/20 hover:scale-105 hover:shadow-[0px_0px_15px_0px_rgba(59,130,246,0.5)] sm:hover:shadow-[0px_0px_25px_0px_rgba(59,130,246,0.5)]"
              style={{
                outline: '1px solid rgba(147, 197, 253, 0.3)',
                outlineOffset: '-1px',
              }}
            >
              <span className="text-white-300 text-sm xs:text-base sm:text-lg md:text-xl font-normal leading-tight">
                Contact Us
              </span>
            </button>
          </div>
