    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-block px-3 xs:px-4 py-1 xs:py-2 bg-gradient-to-r from-orange-500 via-white to-green-600 rounded-full text-xs xs:text-sm font-raleway font-medium text-gray-900 mb-3 xs:mb-4">
              MADE IN INDIA
            </div>
              ...
              <div className="relative z-10">
                ...
                <div className="w-full h-48 xs:h-56 sm:h-64 md:h-72 lg:h-80 bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg xs:rounded-xl hidden items-center justify-center border border-gray-700">
                  <div className="text-center text-gray-400">
                    ...
                    <p className="text-xs xs:text-sm font-raleway">Drone Image</p>
                  </div>
                </div>
              </div>
            </div>
