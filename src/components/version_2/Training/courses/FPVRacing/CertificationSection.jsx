          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-900/30 p-6 rounded-xl border border-gray-800/50">
              <p className="text-[#d5dbe6]/90 font-raleway leading-relaxed text-lg">
                 Get certified as a high-speed FPV drone racer with Aerobott’s immersive training. Build, fly, and refine FPV rigs from components to competition-ready performance.
              </p>
            </div>
