        ...
        <div className="mt-12 text-center">
          <div className="gradient-border inline-block">
            <div className="gradient-border-inner px-8 py-4">
              <p className="text-[#d5dbe6]/80 text-base sm:text-lg font-raleway">
                <span className="text-[#d5dbe6] font-medium">Ready to apply?</span> 
                {' '}Contact us to begin your drone training journey
              </p>
            </div>
          </div>
        </div>
