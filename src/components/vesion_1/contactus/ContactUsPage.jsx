        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <button
                type="submit"
                className="group relative flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 text-white font-medium uppercase tracking-wider transition-all duration-300 hover:from-blue-700 hover:to-blue-800 hover:shadow-lg hover:shadow-blue-500/25 transform hover:scale-[1.02] active:scale-[0.98]"
                style={{ fontFamily: 'Raleway, sans-serif' }}
              >
